...
public class mathwars {
	...
	public static void main(String[] args) {
		...
		String comenzar ="";
		 ...
		 System.out.print(S2 );
		 System.out.print(", pero el sistema de navegación está estropeado y el\n"
		 ...
		 if(p1==r1) {
			...
			System.out.println("Gracias a Chewbacca consiguen llegar al sistema correcto y ven a lo lejos la estrella\n"
					...
					+ "la intención de pasar desapercibidos. De repente suena el comunicador. “Aquín");
					System.out.println("agente de espaciopuerto ");
					System.out.print(d1);
					System.out.print(" contactando con nave imperial ");
					System.out.print(d2);
					System.out.print(". No están destinados\n"
					...
					if(p2==r2) {
						...
						System.out.println("Han Solo proporciona el código correcto. Atracan en la estrella de la muerte, se\n"
								...
								+ "desapercibidos y bajan. Ahora deben averiguar en qué nivel de los ");
								System.out.print(N);
